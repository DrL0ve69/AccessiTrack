...
1\. Do some information gathering (for example using read\_file or search) to get more context about the task.
...
6\. Use the switch\_mode tool to request that the user switch to another mode to implement the solution.
